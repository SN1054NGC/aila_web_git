...
class AccentDictionary:
    ...
    def apply(self, text: str) -> str:
        ...
        for phrase in self.phrases:
            ...
            # Каждое слово экранируем отдельно: re.escape превращает пробел в «\ »,
            # из-за чего шаблон со «\s+» раньше не совпадал ни с одной фразой.
...
if __name__ == "__main__":
    ...
    for src in ["Работа выполнена", "работы по графику", "СИКН №464", "модели оборудования",
                "Привет, Айла!", "уже зад+анное", "FH DN250"]:
